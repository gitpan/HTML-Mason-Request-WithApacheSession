...
sub new
{
    @ISA = 'HTML::Mason::Request::ApacheHandler'
	if $HTML::Mason::ApacheHandler::VERSION;
...
sub session
{
    ...
    return $self->parent->session if $self->is_subrequest;
...
Corresponds to the C<ModSavePath> parameter given to
