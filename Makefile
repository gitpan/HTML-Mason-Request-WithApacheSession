# This Makefile is for the HTML::Mason::Request::WithApacheSession extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/HTML/Mason/Request/WithApacheSession.pm]
#     AUTHOR => q[Dave Rolsky <autarch@urth.org>]
#     NAME => q[HTML::Mason::Request::WithApacheSession]
#     PREREQ_PM => { Apache::Session=>q[1.54], HTML::Mason=>q[1.0901], Apache::Cookie=>q[0] }
#     VERSION_FROM => q[lib/HTML/Mason/Request/WithApacheSession.pm]
...
DISTNAME = HTML-Mason-Request-WithApacheSession
NAME_SYM = HTML_Mason_Request_WithApacheSession
VERSION = 0.03
VERSION_SYM = 0_03
XS_VERSION = 0.03
...
FULLEXT = HTML/Mason/Request/WithApacheSession
BASEEXT = WithApacheSession
PARENT_NAME = HTML::Mason::Request
DLBASE = $(BASEEXT)
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/HTML/Mason/Request/WithApacheSession.pm
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/HTML/Mason/Request
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/HTML/Mason/Request
...
TO_INST_PM = lib/HTML/Mason/Request/WithApacheSession.pm

PM_TO_BLIB = lib/HTML/Mason/Request/WithApacheSession.pm \
	blib/lib/HTML/Mason/Request/WithApacheSession.pm
...
manifypods : pure_all lib/HTML/Mason/Request/WithApacheSession.pm
	@$(POD2MAN) \
	lib/HTML/Mason/Request/WithApacheSession.pm \
	$(INST_MAN3DIR)/HTML::Mason::Request::WithApacheSession.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/HTML/Mason/Request/WithApacheSession.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0,03,0,0\">\n\t<TITLE>$(DISTNAME)</TITLE>\n\t<ABSTRACT>Add a session to the Mason Request object</ABSTRACT>\n\t<AUTHOR>Dave Rolsky &lt;autarch\@urth.org&gt;</AUTHOR>\n}" > $(DISTNAME).ppd
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Apache-Cookie\" VERSION=\"0,0,0,0\" />\n\t\t<DEPENDENCY NAME=\"Apache-Session\" VERSION=\"1,54,0,0\" />\n\t\t<DEPENDENCY NAME=\"HTML-Mason\" VERSION=\"1,0901,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/HTML/Mason/Request/WithApacheSession.pm blib/lib/HTML/Mason/Request/WithApacheSession.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
